...
class Pos_Bridge {
    ...
    private function oliver_pos_register_hooks() {
		...
		add_filter('menu_order', array( $this->pos_bridge_miscellaneous, 'oliver_pos_amelia_menu' ), 10, 1);
    ...
    public function oliver_pos_register_all_api_miscellaneous_routes()
    {
		...
		register_rest_route( $this->namespace, '/amelia-details/', array(
                'methods' => WP_REST_Server::READABLE,
                'callback' => array( $this->pos_bridge_miscellaneous, 'oliver_pos_get_shop_amelia_details' ),
                'permission_callback' => array( $this, 'oliver_pos_rest_authentication' )
            )
        );
        /**
